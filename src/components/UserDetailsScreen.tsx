        ...
        <div className="flex items-center justify-center min-h-[calc(100vh-100px)] px-6">
          <div ref={formRef} className="w-full max-w-md">
            ...
            <div className="text-center mb-12">
              <div className="w-16 h-16 bg-gradient-to-br from-rose-500 to-rose-600 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-rose-500/20">
                <svg
