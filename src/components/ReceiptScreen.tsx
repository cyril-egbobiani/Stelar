  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-8 stagger-item">
        ...
        <p className="text-emerald-100 text-sm sm:text-base opacity-80">
        ...
        <div className="bg-gradient-to-r from-indigo-500/20 to-cyan-500/20 p-4 sm:p-6 border-b border-white/20">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div className="text-right">
              <p className="text-emerald-200 text-sm">Generated</p>
        ...
        <div className="p-4 sm:p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="bg-white/5 rounded-xl p-4 text-center">
              ...
              <div className="text-emerald-200 text-sm">Wellbeing Score</div>
            </div>
            <div className="bg-white/5 rounded-xl p-4 text-center">
              <div
              ...
              <div className="text-emerald-200 text-sm mt-2">Risk Level</div>
            </div>
            <div className="bg-white/5 rounded-xl p-4 text-center">
              <div className="text-white font-medium capitalize">
                {report.emotionalState}
              </div>
              <div className="text-emerald-200 text-sm">Emotional State</div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              {report.keyInsights.map((insight: string, idx: number) => (
                ...
                >
                  <span className="flex-shrink-0 w-6 h-6 bg-emerald-500 text-white rounded-full text-xs font-bold flex items-center justify-center mr-3">
                    {idx + 1}
                  </span>
          ...
          {/* Session Summary */}
          <div className="bg-gradient-to-r from-indigo-500/10 to-cyan-500/10 rounded-xl p-4 border-l-4 border-emerald-400">
      ...
      <div className="mt-6 p-4 bg-white/5 rounded-xl border border-white/10 stagger-item">
        <p className="text-emerald-200 text-xs text-center leading-relaxed">
